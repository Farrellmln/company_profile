            ...
            <div class="card-body">
                <form action="../../actions/extracurriculars/store.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-item">
                        ...
                        <textarea name="description" id="descriptioninput" class="form-control" placeholder="Masukkan deskripsi..." rows="3" required></textarea>
                    </div>
                    ...
                    <div class="form-item">
                       ...
                       <input type="text" class="form-control" id="coachinput" name="coach" placeholder="Masukkan pembimbing..." required>
                    </div>
