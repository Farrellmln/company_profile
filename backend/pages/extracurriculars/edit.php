...
$query = "SELECT * FROM extracurriculars WHERE id = '$id'";
$result = mysqli_query($connect, $query);
$extracurriculars = mysqli_fetch_object($result);
...
<div class="container" style="max-width: 1200px;" class="mx-auto">
    <div class="page-inner">
        <h1 class="mt-4" style="color:#1976d2;">Edit Organisasi</h1>
        <ol class="breadcrumb mb-4">
            <li class="breadcrumb-item"><a href="../dashboard/index.php">Dashboard</a></li>
            <li class="breadcrumb-item"><a href="index.php">Organisasi</a></li>
        ...
        <div class="card w-100 card-box">
            ...
            <div class="card-body">
                <form action="../../actions/extracurriculars/update.php?id=<?= $extracurriculars->id ?>" method="POST" enctype="multipart/form-data">

                    <div class="form-item">
                        <label for="nameinput" class="form-label">
                            <i class="bi bi-megaphone"></i> Nama
                        </label>
                        <input type="text" class="form-control" id="nameinput" name="name" value="<?= htmlspecialchars($extracurriculars->name) ?>" required>
                    </div>
                    ...
                    <div class="form-item">
                        ...
                        <textarea name="description" id="descriptioninput" class="form-control" rows="3" required><?= htmlspecialchars($extracurriculars->description) ?></textarea>
                    </div>

                    <div class="form-item">
                        <label for="coachinput" class="form-label">
                            <i class="bi bi-coach"></i> Pembimbing
                        </label>
                       <input type="text" class="form-control" id="coachinput" name="coach" value="<?= htmlspecialchars($extracurriculars->coach) ?>" required>
                    </div>
                    ...
                    <div class="form-item">
                        ...
                        <img src="../../../storages/extracurriculars/<?= htmlspecialchars($extracurriculars->image) ?>" alt="Gambar Berita Saat Ini" class="img-preview-edit">
