...
<div class="container mx-auto">
    <div class="page-inner">
        <h1 class="mt-4" style="color:#1976d2;">Organisasi Sekolah</h1>
        <ol class="breadcrumb mb-4">
            <li class="breadcrumb-item"><a href="../dashboard/index.php">Dashboard</a></li>
            <li class="breadcrumb-item active">Halaman Organisasi Sekolah</li>
        </ol>

        <div class="card w-100 card-box">
            <div class="card-header">
                <h4 class="card-title">Tabel Organisasi Sekolah</h4>
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table id="aboutTable" class="display table table-bordered table-hover text-center align-middle" style="width:100%">
                        ...
                        <tbody>
                            <?php
                            $query = "SELECT * FROM extracurriculars ORDER BY updated_at DESC";
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <img src="../../../storages/extracurriculars/<?= htmlspecialchars($item->image) ?>" alt="image" class="table-img">
                                    </td>
                                    <td class="small-text"><?= htmlspecialchars($item->coach) ?></td>
                                    <td>
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-center gap-2">
                                            ...
                                            <a href="../../actions/extracurriculars/destroy.php?id=<?= $item->id ?>" class="btn btn-sm btn-danger" title="Hapus" onclick="return confirm('Yakin ingin menghapus data ini?')">
