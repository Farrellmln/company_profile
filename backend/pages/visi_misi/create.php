...
<div class="container" style="max-width: 1200px;" class="mx-auto">
    <div class="page-inner">
        <h1 class="mt-4" style="color:#1976d2;">Tambah Visi & Misi</h1>
        <ol class="breadcrumb mb-4">
            <li class="breadcrumb-item"><a href="../dashboard/index.php">Dashboard</a></li>
            <li class="breadcrumb-item"><a href="index.php">Visi & Misi</a></li>
            <li class="breadcrumb-item active">Halaman Tambah</li>
        </ol>

        <div class="card w-100 card-box">
            <div class="card-header">
                <h4 class="card-title">Form Tambah Visi & Misi</h4>
            </div>
            ...
            <div class="card-body">
                <form action="../../actions/visi_misi/store.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-item">
                        ...
                        <textarea name="visi" id="visiinput" class="form-control" placeholder="Masukkan visi..." rows="3" required></textarea>
                    </div>
                    <div class="form-item">
                        <label for="misiinput" class="form-label">
                            <i class="bi bi-card-text"></i> Misi
                        </label>
                        <textarea name="misi" id="misiinput" class="form-control" placeholder="Masukkan misi..." rows="3" required></textarea>
                    </div>
