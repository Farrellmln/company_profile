...
<div class="container mx-auto">
    <div class="page-inner">
        <h1 class="mt-4" style="color:#1976d2;">Visi & Misi Sekolah</h1>
        <ol class="breadcrumb mb-4">
            <li class="breadcrumb-item"><a href="../dashboard/index.php">Dashboard</a></li>
            <li class="breadcrumb-item active">Halaman Visi & Misi Sekolah</li>
        </ol>

        <div class="card w-100 card-box">
            <div class="card-header">
                <h4 class="card-title">Tabel Visi & Misi Sekolah</h4>
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table id="aboutTable" class="display table table-bordered table-hover text-center align-middle" style="width:100%">
                        ...
                        <tbody>
                            <?php
                            $query = "SELECT * FROM visi_misi ORDER BY id DESC";
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td class="small-text wrap-text">
                                        <?php
                                        $visi = htmlspecialchars($item->visi);
                                        if (strlen($visi) > 50) {
                                            echo substr($visi, 0, 50) . '...';
                                        } else {
                                            echo $visi;
                                        }
                                        ?>
                                    ...
                                    <td class="small-text wrap-text">
                                        <?php
                                        $misi = htmlspecialchars($item->misi);
                                        if (strlen($misi) > 50) {
                                            echo substr($misi, 0, 50) . '...';
                                        } else {
                                            echo $misi;
                                        }
                                        ?>
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-center gap-2">
                                            ...
                                            <a href="../../actions/visi_misi/destroy.php?id=<?= $item->id ?>" class="btn btn-sm btn-danger" title="Hapus" onclick="return confirm('Yakin ingin menghapus data ini?')">
