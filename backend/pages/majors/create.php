...
<div class="container" style="max-width: 1200px;" class="mx-auto">
    <div class="page-inner">
        <h1 class="mt-4" style="color:#1976d2;">Tambah Jurusan</h1>
            ...
            <div class="card-body">
                <form action="../../actions/majors/store.php" method="POST" enctype="multipart/form-data">
                    <div class="form-item">
                        ...
                        <input type="text" class="form-control" id="majors_nameinput" name="majors_name" placeholder="Masukkan nama jurusan..." required>
                    </div>
                    ...
                    <div class="form-item">
                        ...
                        <input type="file" class="form-control" id="majors_imageinput" name="majors_image" required>
                    </div>
                    ...
                    <div class="form-item">
                        ...
                        <textarea name="majors_description" id="majors_descriptioninput" class="form-control" placeholder="Masukkan deskripsi..." rows="3" required></textarea>
                    </div>
                    ...
                    <div class="form-item">
                        ...
                        <input type="text" class="form-control" id="headinput" name="head" placeholder="Masukkan nama kepala jurusan..." required>
                    </div>
