...
<div class="container mx-auto">
    <div class="page-inner">
        <h1 class="mt-4" style="color:#1976d2;">Jurusan Sekolah</h1>
        <ol class="breadcrumb mb-4">
            <li class="breadcrumb-item"><a href="../dashboard/index.php">Dashboard</a></li>
            <li class="breadcrumb-item active">Halaman Jurusan Sekolah</li>
        </ol>

        <div class="card w-100 card-box">
            <div class="card-header">
                <h4 class="card-title">Tabel Jurusan Sekolah</h4>
                    ...
                    <table id="aboutTable" class="display table table-bordered table-hover text-center align-middle" style="width:100%">
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    <td><?= $no++ ?></td>
                                    <td class="small-text"><?= htmlspecialchars($item->majors_name) ?></td>
                                    <td>
                                        <img src="../../../storages/majors/<?= htmlspecialchars($item->majors_image) ?>" alt="image" class="table-img">
                                    </td>
                                    <td class="small-text wrap-text">
                                        <?php
                                        $majors_description = htmlspecialchars($item->majors_description);
                                        if (strlen($majors_description) > 50) {
                                            echo substr($majors_description, 0, 50) . '...';
                                        } else {
                                            echo $majors_description;
                                        }
                                        ?>
                                    </td>
                                    <td class="small-text"><?= htmlspecialchars($item->head) ?></td>
                                    <td>
                                        <div class="d-flex justify-content-center gap-2">
                                            ...
                                            <a href="../../actions/majors/destroy.php?id=<?= $item->id ?>" class="btn btn-sm btn-danger" title="Hapus" onclick="return confirm('Yakin ingin menghapus data ini?')">
