...
$majors = mysqli_fetch_object($result);
...
<div class="container" style="max-width: 1200px;" class="mx-auto">
    <div class="page-inner">
        <h1 class="mt-4" style="color:#1976d2;">Edit Jurusan</h1>
        <ol class="breadcrumb mb-4">
            <li class="breadcrumb-item"><a href="../dashboard/index.php">Dashboard</a></li>
            <li class="breadcrumb-item"><a href="index.php">Jurusan</a></li>
        ...
        <div class="card w-100 card-box">
            ...
            <div class="card-body">
                <form action="../../actions/majors/update.php?id=<?= $majors->id ?>" method="POST" enctype="multipart/form-data">

                    <div class="form-item">
                        <label for="majors_nameinput" class="form-label">
                            <i class="bi bi-megaphone"></i> Nama Jurusan
                        </label>
                        <input type="text" class="form-control" id="majors_nameinput" name="majors_name" value="<?= htmlspecialchars($majors->majors_name) ?>" required>
                    </div>

                    <div class="form-item">
                        <label for="majors_imageinput" class="form-label">
                            <i class="bi bi-image"></i> Gambar
                        </label>
                        <img src="../../../storages/majors/<?= htmlspecialchars($majors->majors_image) ?>" alt="Gambar Galeri Saat Ini" class="img-preview-edit">
                        <input type="file" class="form-control mt-2" id="imageinput" name="majors_image">
                        <small class="form-text text-muted">Kosongkan jika tidak ingin mengganti gambar.</small>
                    </div>

                    <div class="form-item">
                        <label for="majors_descriptioninput" class="form-label">
                            <i class="bi bi-card-text"></i> Deskripsi
                        </label>
                        <textarea name="majors_description" id="majors_descriptioninput" class="form-control" rows="3" required><?= htmlspecialchars($majors->majors_description) ?></textarea>
                    </div>

                    <div class="form-item">
                        <label for="headinput" class="form-label">
                            <i class="bi bi-megaphone"></i> Kepala Jurusan
                        </label>
                        <input type="text" class="form-control" id="headinput" name="head" value="<?= htmlspecialchars($majors->head) ?>" required>
                    </div>
