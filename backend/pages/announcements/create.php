...
<div class="container" style="max-width: 1200px;" class="mx-auto">
    <div class="page-inner">
        <h1 class="mt-4" style="color:#1976d2;">Tambah Pengumuman</h1>
                ...
                <form action="../../actions/announcements/store.php" method="POST" enctype="multipart/form-data">
                    <div class="form-item">
                        <label for="titleinput" class="form-label">
                            <i class="bi bi-megaphone"></i> Judul Pengumuman
                        </label>
                        <input type="text" class="form-control" id="titleinput" name="announcements_title" placeholder="Masukkan judul pengumuman..." required>
                    </div>

                    <div class="form-item">
                        <label for="imageinput" class="form-label">
                            <i class="bi bi-image"></i> Gambar Pengumuman
                        </label>
                        <input type="file" class="form-control" id="imageinput" name="announcements_image" required>
                    </div>
                    ...
                    <div class="form-item">
                        ...
                        <textarea name="announcements" id="announcementsinput" class="form-control" placeholder="Masukkan pengumuman sekolah..." rows="7" required></textarea>
                    </div>
