...
<div class="container">
    <div class="page-inner">
        <h1 class="mt-4 text-center" style="color:#1976d2;">Detail Pengumuman</h1>
        ...
        <div class="card w-100 card-box">
            <div class="card-header">
                <h4 class="card-title">Informasi Detail Pengumuman</h4>
            </div>

            <div class="card-body">
                <div class="detail-item">
                    <div class="detail-label"><i class="bi bi-megaphone"></i> Judul</div>
                    <p><?= htmlspecialchars($announcement->announcements_title) ?></p>
                </div>

                <div class="detail-item">
                    <div class="detail-label"><i class="bi bi-image"></i> Gambar</div>
                    <?php if (!empty($announcement->announcements_image)) : ?>
                        <img src="../../../storages/announcements/<?= htmlspecialchars($announcement->announcements_image) ?>"
                             alt="Gambar Pengumuman" class="img-preview-detail">
                    <?php else : ?>
                ...
                <div class="detail-item">
                    ...
                    <p><?= htmlspecialchars($announcement->date) ?></p>
                </div>

                <div class="detail-item">
                    <div class="detail-label"><i class="bi bi-file-text"></i> Isi</div>
                    <p><?= nl2br(htmlspecialchars($announcement->announcements)) ?></p>
                </div>
