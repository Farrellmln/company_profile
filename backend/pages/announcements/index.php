...
<div class="container mx-auto">
    <div class="page-inner">
        <h1 class="mt-4" style="color:#1976d2;">Pengumuman Sekolah</h1>
        <ol class="breadcrumb mb-4">
            <li class="breadcrumb-item"><a href="../dashboard/index.php">Dashboard</a></li>
            <li class="breadcrumb-item active">Halaman Pengumuman Sekolah</li>
        </ol>

        <div class="card w-100 card-box">
            <div class="card-header">
                <h4 class="card-title">Tabel Pengumuman Sekolah</h4>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td class="small-text wrap-text">
                                        <?php
                                        $title = htmlspecialchars($item->announcements_title);
                                        if (strlen($title) > 50) {
                                    ...
                                    <td>
                                        <img src="../../../storages/announcements/<?= htmlspecialchars($item->announcements_image) ?>" alt="image" class="table-img">
                                    </td>
                                    <td class="small-text"><?= htmlspecialchars($item->date) ?></td>
                                    <td class="small-text wrap-text">
                                        <?php
                                        $announcement = htmlspecialchars($item->announcements);
                                        if (strlen($announcement) > 50) {
                                            echo substr($announcement, 0, 50) . '...';
                                        } else {
                                            echo $announcement;
                                        }
                                        ?>
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-center gap-2">
                                            ...
                                            <a href="../../actions/announcements/destroy.php?id=<?= $item->id ?>" class="btn btn-sm btn-danger" title="Hapus" onclick="return confirm('Yakin ingin menghapus data ini?')">
