...
<div class="container" style="max-width: 1200px;" class="mx-auto">
    <div class="page-inner">
        <h1 class="mt-4" style="color:#1976d2;">Tambah Guru</h1>
            ...
            <div class="card-body">
                <form action="../../actions/teachers/store.php" method="POST" enctype="multipart/form-data">
                    <div class="form-item">
                        ...
                        <input type="text" class="form-control" id="teachers_nameinput" name="teachers_name" placeholder="Masukkan nama guru..." required>
                    </div>
                    ...
                    <div class="form-item">
                        ...
                        <input type="file" class="form-control" id="teachers_photoinput" name="teachers_photo" required>
                    </div>
                    ...
                    <div class="form-item">
                        ...
                        <input type="text" id="teachers_majorinput" class="form-control" name="teachers_major" placeholder="Masukkan jurusan..." required>
                    </div>
                    ...
                    <div class="form-item">
                        ...
                        <select class="form-control" id="jkinput" name="jk" required>
