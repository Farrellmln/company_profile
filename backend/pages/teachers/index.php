...
<div class="container mx-auto">
    <div class="page-inner">
        <h1 class="mt-4" style="color:#1976d2;">Guru Sekolah</h1>
        <ol class="breadcrumb mb-4">
            <li class="breadcrumb-item"><a href="../dashboard/index.php">Dashboard</a></li>
            <li class="breadcrumb-item active">Halaman Guru Sekolah</li>
        </ol>

        <div class="card w-100 card-box">
            <div class="card-header">
                <h4 class="card-title">Tabel Guru Sekolah</h4>
                    ...
                    <table id="aboutTable" class="display table table-bordered table-hover text-center align-middle" style="width:100%">
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    <td><?= $no++ ?></td>
                                    <td class="small-text"><?= htmlspecialchars($item->teachers_name) ?></td>
                                    <td>
                                        <img src="../../../storages/teachers/<?= htmlspecialchars($item->teachers_photo) ?>" alt="image" class="table-img">
                                    </td>
                                    <td class="small-text"><?= htmlspecialchars($item->teachers_major) ?></td>
                                    <td class="small-text"><?= htmlspecialchars($item->jk) ?></td>
                                    <td>
                                        <div class="d-flex justify-content-center gap-2">
                                            ...
                                            <a href="../../actions/teachers/destroy.php?id=<?= $item->id ?>" class="btn btn-sm btn-danger" title="Hapus" onclick="return confirm('Yakin ingin menghapus data ini?')">
