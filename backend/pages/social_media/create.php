...
<div class="container" style="max-width: 1200px;" class="mx-auto">
    <div class="page-inner">
        <h1 class="mt-4" style="color:#1976d2;">Tambah Sosial Media</h1>
        ...
        <div class="card w-100 card-box">
            <div class="card-header">
                <h4 class="card-title">Form Tambah Sosial Media</h4>
            </div>
            ...
            <div class="card-body">
                <form action="../../actions/social_media/store.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-item">
                        ...
                        <input type="text" class="form-control" id="title_input" name="title" placeholder="Masukkan nama judul..." required>
                    </div>
