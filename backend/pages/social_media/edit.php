...
<div class="container" style="max-width: 1200px;" class="mx-auto">
    <div class="page-inner">
        <h1 class="mt-4" style="color:#1976d2;">Edit Sosial Media</h1>
        <ol class="breadcrumb mb-4">
            <li class="breadcrumb-item"><a href="../dashboard/index.php">Dashboard</a></li>
            <li class="breadcrumb-item"><a href="index.php">Sosial Media</a></li>
            <li class="breadcrumb-item active">Halaman Edit</li>
        </ol>

        <div class="card w-100 card-box">
            <div class="card-header">
                <h4 class="card-title">Form Edit Sosial Media</h4>
            </div>
            ...
            <div class="card-body">
                <form action="../../actions/social_media/update.php?id=<?= $social_media->id ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-item">
                        ...
                        <input type="text" class="form-control" id="icon_input" name="icon"value="<?= htmlspecialchars($social_media->icon) ?>" required>
                    </div>
                    ...
                    <div class="form-item">
                        ...
                        <input type="text" class="form-control" id="title_input" name="title" value="<?= htmlspecialchars($social_media->title) ?>" required>
                    </div>

                    <div class="form-item">
                        <label for="link_urlinput" class="form-label">
                            <i class="bi bi-megaphone"></i> Link url
                        </label>
                        <input type="url" class="form-control" id="link_urlinput" name="link_url" value="<?= htmlspecialchars($social_media->link_url) ?>" required>
                    </div>
