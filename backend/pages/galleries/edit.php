...
$galleries = mysqli_fetch_object($result);
...
<div class="container" style="max-width: 1200px;" class="mx-auto">
    <div class="page-inner">
        <h1 class="mt-4" style="color:#1976d2;">Edit Galeri</h1>
        ...
        <div class="card w-100 card-box">
            ...
            <div class="card-body">
                <form action="../../actions/galleries/update.php?id=<?= $galleries->id ?>" method="POST" enctype="multipart/form-data">

                    <div class="form-item">
                        <label for="imageinput" class="form-label">
                            <i class="bi bi-image"></i> Gambar
                        </label>
                        <img src="../../../storages/galleries/<?= htmlspecialchars($galleries->image) ?>" alt="Gambar Galeri Saat Ini" class="img-preview-edit">
                    ...
                    <div class="form-item">
                        <label for="authorinput" class="form-label">
                            <i class="bi bi-megaphone"></i> Pengarang
                        </label>
                        <input type="text" class="form-control" id="authorinput" name="author" placeholder="Masukkan nama pengarang..." value="<?= htmlspecialchars($galleries->author) ?>" required>
                    </div>
                    ...
                    <div class="form-item">
                        ...
                        <input type="date" class="form-control" name="date" id="dateinput" value="<?= htmlspecialchars($galleries->date) ?>" required>
                    </div>
                    ...
                    <div class="form-item">
                        ...
                        <textarea name="description" id="descriptioninput" class="form-control" rows="3" required><?= htmlspecialchars($galleries->description) ?></textarea>
                    </div>
