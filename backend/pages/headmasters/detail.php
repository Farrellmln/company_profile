...
<div class="container">
    <div class="page-inner">
        <h1 class="mt-4 text-center" style="color:#1976d2;">Detail Kepala Sekolah</h1>
        ...
        <div class="card w-100 card-box">
            <div class="card-header">
                <h4 class="card-title">Informasi Detail Kepala Sekolah</h4>
            </div>

            <div class="card-body">
                <div class="detail-item">
                    <div class="detail-label"><i class="bi bi-person"></i> Nama</div>
                    <p><?= htmlspecialchars($headmasters->headmaster_name) ?></p>
                </div>

                <div class="detail-item">
                    <div class="detail-label"><i class="bi bi-image"></i> Gambar</div>
                    <?php if (!empty($headmasters->headmaster_image)) : ?>
                        <img src="../../../storages/headmasters/<?= htmlspecialchars($headmasters->headmaster_image) ?>"
                            alt="Gambar Kepala Sekolah" class="img-preview-detail">
                    <?php else : ?>
                ...
                <div class="detail-item">
                    ...
                    <p style="white-space: pre-line; line-height: 1.6;"><?= htmlspecialchars($headmasters->headmaster_description) ?></p>
                </div>
