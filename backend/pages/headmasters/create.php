...
<div class="container" style="max-width: 1200px;" class="mx-auto">
    <div class="page-inner">
        <h1 class="mt-4" style="color:#1976d2;">Tambah Galeri</h1>
            ...
            <div class="card-body">
                <form action="../../actions/headmasters/store.php" method="POST" enctype="multipart/form-data">
                    <div class="form-item">
                        ...
                        <input type="text" class="form-control" id="headmaster_nameinput" name="headmaster_name" placeholder="Masukkan nama kepala sekolah..." required>
                    </div>
                    ...
                    <div class="form-item">
                        ...
                        <input type="file" class="form-control" id="headmaster_imageinput" name="headmaster_image" required>
                    </div>
                    ...
                    <div class="form-item">
                        ...
                        <textarea name="headmaster_description" id="headmaster_descriptioninput" class="form-control" placeholder="Masukkan deskripsi..." rows="3" required></textarea>
                    </div>
