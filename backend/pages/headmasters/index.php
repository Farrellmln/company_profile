...
<div class="container mx-auto">
    <div class="page-inner">
        <h1 class="mt-4" style="color:#1976d2;">Kepala Sekolah</h1>
        <ol class="breadcrumb mb-4">
            <li class="breadcrumb-item"><a href="../dashboard/index.php">Dashboard</a></li>
            <li class="breadcrumb-item active">Halaman Kepala Sekolah</li>
        </ol>

        <div class="card w-100 card-box">
            <div class="card-header">
                <h4 class="card-title">Tabel Kepala Sekolah</h4>
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table id="aboutTable" class="display table table-bordered table-hover text-center align-middle" style="width:100%">
                        ...
                        <tbody>
                            <?php
                            $query = "SELECT * FROM headmasters ORDER BY id DESC";
                            ...
                            ?>
                                <tr>
                                    <td><?= $no++ ?></td>
                                    <td class="small-text"><?= htmlspecialchars($item->headmaster_name) ?></td>
                                    <td>
                                        <img src="../../../storages/headmasters/<?= htmlspecialchars($item->headmaster_image) ?>" alt="image" class="table-img">
                                    </td>
                                    <td class="small-text wrap-text">
                                        <?php
                                        $headmaster_description = htmlspecialchars($item->headmaster_description);
                                        if (strlen($headmaster_description) > 50) {
                                            echo substr($headmaster_description, 0, 50) . '...';
                                        } else {
                                            echo $headmaster_description;
                                        }
                                        ?>
                                    </td>
                                    <td>
                                        <div class="d-flex justify-content-center gap-2">
                                            ...
                                            <a href="../../actions/headmasters/destroy.php?id=<?= $item->id ?>" class="btn btn-sm btn-danger" title="Hapus" onclick="return confirm('Yakin ingin menghapus data ini?')">
