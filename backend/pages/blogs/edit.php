...
$blogs = mysqli_fetch_object($result);
...
<div class="container" style="max-width: 1200px;" class="mx-auto">
    <div class="page-inner">
        <h1 class="mt-4" style="color:#1976d2;">Edit Berita</h1>
        ...
        <div class="card w-100 card-box">
            ...
            <div class="card-body">
                <form action="../../actions/blogs/update.php?id=<?= $blogs->id ?>" method="POST" enctype="multipart/form-data">

                    <div class="form-item">
                        <label for="imageinput" class="form-label">
                            <i class="bi bi-image"></i> Gambar 
                        </label>
                        <img src="../../../storages/blogs/<?= htmlspecialchars($blogs->image) ?>" alt="Gambar Berita Saat Ini" class="img-preview-edit">
                    ...
                    <div class="form-item">
                        ...
                        <input type="text" class="form-control" id="titleinput" name="title" value="<?= htmlspecialchars($blogs->title) ?>" required>
                    </div>
                    ...
                    <div class="form-item">
                        ...
                        <input type="date" class="form-control" id="dateinput" name="date" value="<?= htmlspecialchars($blogs->date) ?>" required>
                    </div>

                    <div class="form-item">
                        <label for="authorinput" class="form-label">
                            <i class="bi bi-author"></i> Pengarang
                        </label>
                       <input type="text" class="form-control" id="authorinput" name="author" value="<?= htmlspecialchars($blogs->author) ?>" required>
                    </div>

                    <div class="form-item">
                        <label for="contentinput" class="form-label">
                            <i class="bi bi-card-text"></i> Konten
                        </label>
                        <textarea name="content" id="contentinput" class="form-control"  rows="3" required><?= htmlspecialchars($blogs->content) ?></textarea>
                    </div>
