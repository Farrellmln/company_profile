...
<div class="container" style="max-width: 1200px;" class="mx-auto">
    <div class="page-inner">
        <h1 class="mt-4" style="color:#1976d2;">Tambah Berita</h1>
            ...
            <div class="card-body">
                <form action="../../actions/blogs/store.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-item">
                        ...
                        <textarea name="content" id="contentinput" class="form-control" placeholder="Masukkan konten..." rows="3" required></textarea>
                    </div>
