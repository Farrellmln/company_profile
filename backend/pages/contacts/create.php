...
<div class="container" style="max-width: 1200px;" class="mx-auto">
    <div class="page-inner">
        <h1 class="mt-4" style="color:#1976d2;">Tambah Kontak</h1>
        ...
        <div class="card w-100 card-box">
            ...
            <div class="card-body">
                <form action="../../actions/contacts/store.php" method="POST" enctype="multipart/form-data">
                    <div class="form-item">
                        <label for="icon_input" class="form-label">
                            <i class="bi bi-code-square"></i> Kode Ikon
                        </label>
                        <input type="text" class="form-control" id="icon_input" name="icon" placeholder="Contoh: bi bi-facebook" required>
                    </div>
                    ...
                    <div class="form-item">
                        ...
                        <input type="text" class="form-control" id="contactinput" name="contact" placeholder="Masukkan nama kontak..." required>
                    </div>
                    ...
                    <div class="form-item">
                        ...
                        <input type="url" class="form-control" id="link_urlinput" name="link_url" placeholder="Masukkan link url..." required>
                    </div>
