...
<div class="container mx-auto">
    <div class="page-inner">
        <h1 class="mt-4" style="color:#1976d2;">Kontak Sekolah</h1>
        <ol class="breadcrumb mb-4">
            <li class="breadcrumb-item"><a href="../dashboard/index.php">Dashboard</a></li>
            <li class="breadcrumb-item active">Halaman Kontak Sekolah</li>
        </ol>

        <div class="card w-100 card-box">
            <div class="card-header">
                <h4 class="card-title">Tabel Kontak Sekolah</h4>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td class="small-text"><?= htmlspecialchars($item->contact) ?></td>
                                    <td class="small-text"><?= htmlspecialchars($item->email) ?></td>
                                    <td class="small-text"><?= htmlspecialchars($item->link_url) ?></td>
                                    <td>
                                        <div class="d-flex justify-content-center gap-2">
                                            <a href="edit.php?id=<?= $item->id ?>" class="btn btn-sm btn-warning" title="Ubah">
                                                <i class="bi bi-pencil-square"></i>
                                            </a>
                                            <a href="../../actions/contacts/destroy.php?id=<?= $item->id ?>" class="btn btn-sm btn-danger" title="Hapus" onclick="return confirm('Yakin ingin menghapus data ini?')">
