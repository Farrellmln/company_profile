...
<div class="container" style="max-width: 1200px;" class="mx-auto">
    <div class="page-inner">
        <h1 class="mt-4" style="color:#1976d2;">Edit Kontak</h1>
        <ol class="breadcrumb mb-4">
            <li class="breadcrumb-item"><a href="../dashboard/index.php">Dashboard</a></li>
            <li class="breadcrumb-item"><a href="index.php">Kontak</a></li>
        ...
        <div class="card w-100 card-box">
            ...
            <div class="card-body">
                <form action="../../actions/contacts/update.php?id=<?= $contacts->id ?>" method="POST" enctype="multipart/form-data">

                    <div class="form-item">
                        <label for="icon_input" class="form-label">
                            <i class="bi bi-code-square"></i> Kode Ikon
                        </label>
                        <input type="text" class="form-control" id="icon_input" name="icon"value="<?= htmlspecialchars($contacts->icon) ?>" required>
                    </div>

                    <div class="form-item">
                        <label for="contactinput" class="form-label">
                            <i class="bi bi-megaphone"></i> Kontak
                        </label>
                        <input type="text" class="form-control" id="contactinput" name="contact" placeholder="Masukkan nama kontak..." value="<?= htmlspecialchars($contacts->contact) ?>" required>
                    </div>

                    <div class="form-item">
                        <label for="emailinput" class="form-label">
                            <i class="bi bi-megaphone"></i> Email
                        </label>
                        <input type="email" class="form-control" id="emailinput" name="email" placeholder="Masukkan email..." value="<?= htmlspecialchars($contacts->email) ?>" required>
                    </div>

                    <div class="form-item">
                        <label for="link_urlinput" class="form-label">
                            <i class="bi bi-megaphone"></i> Link Tautan
                        </label>
                        <input type="url" class="form-control" id="link_urlinput" name="link_url" placeholder="Masukkan link url..." value="<?= htmlspecialchars($contacts->link_url) ?>" required>
                    </div>
