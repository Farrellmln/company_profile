...
$achievements = mysqli_fetch_object($result);
...
<div class="container" style="max-width: 1200px;" class="mx-auto">
    <div class="page-inner">
        <h1 class="mt-4" style="color:#1976d2;">Edit Prestasi</h1>
        ...
        <div class="card w-100 card-box">
            ...
            <div class="card-body">
                <form action="../../actions/achievements/update.php?id=<?= $achievements->id ?>" method="POST" enctype="multipart/form-data">
                    <div class="form-item">
                        <label for="gambarinput" class="form-label">
                            <i class="bi bi-image"></i> Gambar
                        </label><br>
                        <img src="../../../storages/achievements/<?= htmlspecialchars($achievements->image) ?>" alt="Gambar Prestasi Saat Ini" class="img-preview-edit">
                        <input type="file" class="form-control mt-2" id="gambarinput" name="image">
                    ...
                    <div class="form-item">
                        ...
                        <input type="text" class="form-control" name="author" id="authorinput" value="<?= htmlspecialchars($achievements->author) ?>" required>
                    </div>
                    ...
                    <div class="form-item">
                        ...
                        <input type="date" class="form-control" name="date" id="dateinput" value="<?= htmlspecialchars($achievements->date) ?>" required>
                    </div>

                    <div class="form-item">
                        <label for="titleinput" class="form-label">
                            <i class="bi bi-patch-check"></i> Judul
                        </label>
                        <input type="text" class="form-control" name="title" id="titleinput" value="<?= htmlspecialchars($achievements->title) ?>" required>
                    </div>
                    ...
                    <div class="form-item">
                        ...
                        <textarea name="description" id="descriptioninput" class="form-control" rows="7"><?= htmlspecialchars($achievements->description) ?></textarea>
                    </div>
