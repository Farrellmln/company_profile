...
<div class="container" style="max-width: 1200px;" class="mx-auto">
    <div class="page-inner">
        <h1 class="mt-4" style="color:#1976d2;">Tambah Prestasi</h1>
            ...
            <div class="card-body">
                <form action="../../actions/achievements/store.php" method="POST" enctype="multipart/form-data">
                    <div class="form-item">
                        ...
                        <input type="file" class="form-control" id="gambarinput" name="image" required>
                    </div>
                    ...
                    <div class="form-item">
                        ...
                        <input type="text" class="form-control" id="authorinput" name="author" placeholder="Masukkan pengarang..." required>
                    </div>
                    ...
                    <div class="form-item">
                        ...
                        <input type="text" class="form-control" id="titleinput" name="title" placeholder="Masukkan judul..." required>
                    </div>
                    ...
                    <div class="form-item">
                        ...
                        <textarea name="description" id="descriptioninput" class="form-control" placeholder="Masukkan deskripsi..." rows="7" required></textarea>
                    </div>
