...
if (!isset($_GET['id'])) {
    echo "
        <script>
            alert('ID tidak valid. Silakan pilih data yang akan dilihat.');
...
<div class="container">
    <div class="page-inner">
        <h1 class="mt-4 text-center" style="color:#1976d2;">Detail Testimoni</h1>
        ...
        <div class="card w-100 card-box">
            <div class="card-header">
                <h4 class="card-title">Tabel Detail Testimoni</h4>
            </div>

            <div class="card-body">
                <div class="detail-item">
                    <div class="detail-label"><i class="bi bi-image"></i> Gambar</div>
                    <img src="../../../storages/testimonials/<?= htmlspecialchars($testimonial->image) ?>"
                        alt="Gambar Testimoni" class="img-preview-detail">
                </div>
                ...
                <div class="detail-item">
                    <div class="detail-label"><i class="bi bi-check-circle"></i> Status</div>
                    <p><?= htmlspecialchars($testimonial->status) ?></p>
                </div>

                <div class="detail-item">
                    <div class="detail-label"><i class="bi bi-chat-text"></i> Pesan</div>
